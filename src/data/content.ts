...
export const jobs: Job[] = [
  {
    ...
    bullets: [
      ...
      "Reduced a client's monthly AWS spend by approximately 25–30% through utilisation-based rightsizing, scheduled non-production shutdowns, and controlled cleanup of idle resources.",
      "Automated rolling and blue-green Kubernetes deployments using GitHub Actions, Jenkins, Argo CD, and GitOps, reducing release-cycle time by 35% across 8+ environments.",
      "Collaborated with 5+ customers to gather requirements and design scalable AWS and Azure cloud architectures for production platforms.",
      "Improved incident response by implementing observability with Datadog and Grafana, reducing detection time by 40% and MTTR by 25% through custom alerting and monitoring dashboards.",
      "Implemented least-privilege IAM controls and integrated Keycloak-based SSO across 6+ applications, strengthening platform security and access governance.",
      "Investigated 15+ production incidents across deployment and infrastructure layers, collaborating with development teams on RCA, mitigation, and long-term reliability improvements.",
    ],
  },
  {
    id: "xgrid",
